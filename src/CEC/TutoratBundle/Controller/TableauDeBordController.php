...
class TableauDeBordController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        if (!$membre->getGroupe())
        {
            $this->get('session')->setFlash('success', 'Bonjour ' . $membre->getPrenom() . ' et bienvenue sur le site interne de CEC ! Tu n\'a pas encore complété ton profil et le groupe de tutorat auquel tu appartiens. Fais-le dès maintenant, en cliquant sur "Modifier mon profil", en bas à gauche de cette page.');
        ...
        if ($seances)
        {
            ...
            $this->get('session')->setFlash('info', 'Aucune séance de tutorat n\'est prévue ! Pour en créer une, utilisez le bouton ci-dessous.');
